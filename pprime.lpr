...
function vynasob2(c1, c2 : cisloT) : cisloT;
var vysl : cisloT;
...
begin
     ...
     begin
          ...
          if(vysl.cislo[i+c1.delka+1] > 0) then vysl.delka := i+c1.delka+1
          else vysl.delka := i+c1.delka;
     end;
...
var vysledek : cisloT;
var delka, i, posledniNenul : integer;
var zb, porov : byte;
begin
     vysledek.delka := 0;
     vynuluj(vysledek);
     ...
     begin
          ...
          vysledek.cislo[i] := porov mod 10;
          if(vysledek.cislo[i] > 0) then posledniNenul := i;
...
begin
     ...
     if(vysl.cislo[c1.delka*2] > 0) then vysl.delka := c1.delka*2
     else vysl.delka := c1.delka*2 - 1;
...
begin
  ...
  begin
      ...
      begin
           vysledek := modulo(vynasob2(vysledek, base), modulus);
      end;
      exponent := temp.vysl;
